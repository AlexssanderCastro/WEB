                ...
                <form action="edit.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="id-cpf" name="campo-cpf" value="<?=$item->cpf?>" required
                                maxlength="11" >
                        </div>
                        <div class="col-lg-4 mb-3">
                            <label for="id-salario" class="form-label">Salário:</label>
                            <input type="text" class="form-control" id="id-salario" name="campo-salario" value="<?=$item->salario?>"
                                required>
                        </div>
                        <div class="col-lg-4 mb-3">
                        ...
                        <div class="col-lg-8 mb-3">
                            ...
                            <textarea class="form-control" id="id-obs" rows="3" name="campo-obs"><?=$item->obs?></textarea>
                        </div>
                        <div class="col-12">
