...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-9">
                <h3 class="mt-3">Adicionar Atividade</h3>
                <form action="add.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-5 mb-3">
                            ...
                            <input type="text" class="form-control" id="id-responsavel" name="campo-responsavel" value="">
                        </div>
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="time" class="form-control" id="id-hora" name="campo-hora" value="" required>
                        </div>
                        <div class="col-lg-8 mb-3">
                            <label for="id-descricao" class="form-label">Descrição:</label>
                            <textarea class="form-control" id="id-descricao" rows="3" name="campo-descricao"></textarea>
                        </div>
                        <div class="col-12">
